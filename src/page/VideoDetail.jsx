            ...
            <div className={style.detailWrap}>
                <div className={style.videoInfo}>
                    <div className={style.videoWrap}>
                        <iframe className={style.video} src={`http://www.youtube.com/embed/${videoInfo.id}`} allowFullScreen></iframe>
                    </div>
                    ...
                    <div className={style.countAndDate}>
                        ...
                        <div className={style.likeCountWrap}>
                            ...
                            <div className={style.dislikeCount}>{numberWithCommas(videoInfo.statistics.dislikeCount)}</div>
                        </div>
                    </div>
                    {/* 동영상 설명란 */}
                    ...
                    <div className={style.commentInfo}>
                        {videoInfo.statistics.commentCount && <>댓글 {numberWithCommas(videoInfo.statistics.commentCount)}개</>}
                        <div className={style.commentOrderWrap}>
                            <button className={style.commentOrderBtn} onClick={setCommentOrderSelectBox}>
                                <img src="/images/orderBtn.png" />
                                정렬 기준
                            </button>
                            <div ref={commentOrderSelectBox} style={{ display: 'none' }} className={style.commentOrderSelectBox}>
                                <div
                    ...
                    <div className={style.commentList}>
                        ...
                        <button ref={commentSeeMoreBtn} className={style.seeMoreBtn} onClick={getVideoComment}>
                            더보기
                        </button>
                    </div>
                </div>
                ...
                <div className={style.playList}>
                    ...
                    <button ref={popularSeeMoreBtn} className={style.seeMoreBtn} onClick={getMostPopularList}>
                        더보기
                    </button>
                </div>
            </div>
